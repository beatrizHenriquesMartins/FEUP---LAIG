...
MyTriangle.prototype.loadTexture = function (texture) {
  ...
  var a = Math.sqrt(Math.pow(this.x2 - this.x3, 2) 
                    + Math.pow(this.y2 - this.y3, 2) 
                    + Math.pow(this.z2 - this.z3, 2));
  var b = Math.sqrt(Math.pow(this.x1 - this.x3, 2) 
                    + Math.pow(this.y1 - this.y3, 2) 
                    + Math.pow(this.z1 - this.z3, 2));
  var c = Math.sqrt(Math.pow(this.x1 - this.x2, 2) 
